...
export const programId = (cluster: SolCluster) => {
  if (cluster === "devnet") {
    return new PublicKey("EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj");
  } else if (["mainnet", "mainnet-beta"].includes(cluster)) {
    return new PublicKey("srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX");
  } else {
